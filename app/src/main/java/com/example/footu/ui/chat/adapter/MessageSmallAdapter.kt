...
class MessageSmallAdapter :
    ListAdapter<MessageResponse, RecyclerView.ViewHolder>(
        object :
    ...
    override fun onCreateViewHolder(
        ...
        return when (p1) {
            VIEW_TYPE_ONE -> {
                val view = inflater.inflate(R.layout.send_chat_layout_small, p0, false)
                SenderViewHolder(view)
            }

            VIEW_TYPE_TWO -> {
                val view = inflater.inflate(R.layout.receive_chat_layout_small, p0, false)
                ReceiverViewHolder(view)
            }

            IMAGE_SENDER -> {
                val view = inflater.inflate(R.layout.send_image_layout_small, p0, false)
                ImageSenderViewHolder(view)
            }

            IMAGE_RECEIVER -> {
                val view = inflater.inflate(R.layout.receive_image_layout_small, p0, false)
                ImageReceiverViewHolder(view)
            }

            VIDEO_SENDER -> {
                val view = inflater.inflate(R.layout.send_video_layout_small, p0, false)
                VideoSenderViewHolder(view)
            }

            VIDEO_RECEIVER -> {
                val view = inflater.inflate(R.layout.receive_video_layout_small, p0, false)
